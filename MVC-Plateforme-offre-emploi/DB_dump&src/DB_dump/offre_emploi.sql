...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 08 oct. 2024 à 15:45
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `last_login`, `role_id_fk`) VALUES
(1, 'admin', '$2y$10$YsO3x28U1OQv9FP3Jp2MGufYarEChI5sbVCTe6h1g9bX3fJSXXFi.', 'admin@admin.admin', '2024-10-08 13:44:03', 1);
...
--
ALTER TABLE `specialite`
  ADD CONSTRAINT `specialite_ibfk_1` FOREIGN KEY (`user_id_fk`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
